...
.relative.px-4(class='sm:px-6 lg:px-8')
  .text-lg.mx-auto
    h3.mt-2.block.text-3xl.text-center.leading-8.font-extrabold(class='sm:text-4xl') Who We Are
    p.mt-8.text-xl.text-gray-500.leading-8
      | foo
  .text-lg.mx-auto
    h3.mt-2.block.text-3xl.text-center.leading-8.font-extrabold(class='sm:text-4xl') Why Join Us
    p.mt-8.text-xl.text-gray-500.leading-8
      | foo
  p.text-center.text-base.font-semibold.uppercase.text-gray-600.tracking-wider
  .text-lg.mx-auto
    h2.block.text-base.text-center.text-indigo-600.font-semibold.tracking-wide.uppercase History
    h3.mt-2.block.text-3xl.text-center.leading-8.font-extrabold(class='sm:text-4xl') 2003
    p.mt-8.text-xl.text-gray-500.leading-8
  ...
  .text-lg.mx-auto
    h3.mt-2.block.text-3xl.text-center.leading-8.font-extrabold(class='sm:text-4xl') 2004
    p.mt-8.text-xl.text-gray-500.leading-8
  ...
  .text-lg.mx-auto
    h3.mt-2.block.text-3xl.text-center.leading-8.font-extrabold(class='sm:text-4xl')  2007
    p.mt-8.text-xl.text-gray-500.leading-8
  ...
  .text-lg.mx-auto
    h3.mt-2.block.text-3xl.text-center.leading-8.font-extrabold(class='sm:text-4xl')  2008
    p.mt-8.text-xl.text-gray-500.leading-8
  ...
  .text-lg.mx-auto
    h3.mt-2.block.text-3xl.text-center.leading-8.font-extrabold(class='sm:text-4xl')  2010
    p.mt-8.text-xl.text-gray-500.leading-8
  ...
  .text-lg.mx-auto
    h3.mt-2.block.text-3xl.text-center.leading-8.font-extrabold(class='sm:text-4xl')  2011
    p.mt-8.text-xl.text-gray-500.leading-8
      | The group has once again reformed into a small group (10-15) casually PvPing in Star War: The Old Republic.
  .text-lg.mx-auto
    h3.mt-2.block.text-3xl.text-center.leading-8.font-extrabold(class='sm:text-4xl')  2012
    p.mt-8.text-xl.text-gray-500.leading-8
  ...
  .text-lg.mx-auto
    h3.mt-2.block.text-3xl.text-center.leading-8.font-extrabold(class='sm:text-4xl')  2017
    p.mt-8.text-xl.text-gray-500.leading-8
  ...
  .text-lg.mx-auto
    h3.mt-2.block.text-3xl.text-center.leading-8.font-extrabold(class='sm:text-4xl')  2020
    p.mt-8.text-xl.text-gray-500.leading-8
      | Some members of both HAYABUSA and Koga played a bit of Albion Online, but it didn't stick for most.
  .text-lg.mx-auto
    h3.mt-2.block.text-3xl.text-center.leading-8.font-extrabold(class='sm:text-4xl')  Present
    p.mt-8.text-xl.text-gray-500.leading-8
      | After 15 years of waiting for a great MMORPG, is Ashes of Creation it? we sure hope so!  In the meantime we play an assortment of games together.  Among Us, Overwatch, Sea of Thieves, and GTAV are some of the games we play, and are always open to try new games as a group.s
  .text-lg.mx-auto
    h3.mt-2.block.text-3xl.text-center.leading-8.font-extrabold(class='sm:text-4xl')  Videos
.max-w-7xl.mx-auto.py-12.px-4(class="sm:px-6 lg:py-16 lg:px-8")
  .mt-6.grid.grid-cols-2(class="gap-0.5 md:grid-cols-2 lg:mt-8")
    .col-span-1.flex.justify-center.py-8.px-8.bg-gray-800(
      v-for="embed in videos"
    )
      iframe(
        width="560"
        height="315"
